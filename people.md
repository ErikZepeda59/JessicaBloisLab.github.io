...
<div style="width: 250px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 8px; overflow: hidden; text-align: center; background-color: #fff; transition: transform 0.2s, box-shadow 0.2s;"
  ...
  <div style="padding: 1rem;">
    <h3 style="margin-bottom: 0.25rem;">Full Name</h3>
    <p style="font-size: 0.9rem; color: gray;">Position, Institution</p>
    <p><a href="mailto:example@university.edu">📧 example@university.edu</a></p>
    <p><a href="https://example.com" target="_blank">🌐 Website</a></p>
  </div>
</div>
